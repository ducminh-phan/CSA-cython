...
struct __pyx_vtabstruct_3csa_3csa_ConnectionScan {
  PyObject *(*update_departure_stop)(struct __pyx_obj_3csa_3csa_ConnectionScan *, int);
  PyObject *(*update_out_hubs)(struct __pyx_obj_3csa_3csa_ConnectionScan *, int, int, int);
  PyObject *(*query)(struct __pyx_obj_3csa_3csa_ConnectionScan *, int, int, int);
...
static PyObject *__pyx_f_3csa_3csa_14ConnectionScan_update_departure_stop(CYTHON_UNUSED struct __pyx_obj_3csa_3csa_ConnectionScan *__pyx_v_self, CYTHON_UNUSED int __pyx_v_dep_id); /* proto*/
static PyObject *__pyx_f_3csa_3csa_14ConnectionScan_update_out_hubs(CYTHON_UNUSED struct __pyx_obj_3csa_3csa_ConnectionScan *__pyx_v_self, CYTHON_UNUSED int __pyx_v_arr_id, CYTHON_UNUSED int __pyx_v_arrival_time, CYTHON_UNUSED int __pyx_v_target_id); /* proto*/
static PyObject *__pyx_f_3csa_3csa_14ConnectionScan_query(CYTHON_UNUSED struct __pyx_obj_3csa_3csa_ConnectionScan *__pyx_v_self, CYTHON_UNUSED int __pyx_v_source_id, CYTHON_UNUSED int __pyx_v_target_id, CYTHON_UNUSED int __pyx_v_departure_time); /* proto*/
...
static PyObject *__pyx_f_3csa_3csa_14ConnectionScan_update_departure_stop(CYTHON_UNUSED struct __pyx_obj_3csa_3csa_ConnectionScan *__pyx_v_self, CYTHON_UNUSED int __pyx_v_dep_id) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
...
static PyObject *__pyx_f_3csa_3csa_14ConnectionScan_update_out_hubs(CYTHON_UNUSED struct __pyx_obj_3csa_3csa_ConnectionScan *__pyx_v_self, CYTHON_UNUSED int __pyx_v_arr_id, CYTHON_UNUSED int __pyx_v_arrival_time, CYTHON_UNUSED int __pyx_v_target_id) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
...
static PyObject *__pyx_f_3csa_3csa_14ConnectionScan_query(CYTHON_UNUSED struct __pyx_obj_3csa_3csa_ConnectionScan *__pyx_v_self, CYTHON_UNUSED int __pyx_v_source_id, CYTHON_UNUSED int __pyx_v_target_id, CYTHON_UNUSED int __pyx_v_departure_time) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  __pyx_vtable_3csa_3csa_ConnectionScan.update_departure_stop = (PyObject *(*)(struct __pyx_obj_3csa_3csa_ConnectionScan *, int))__pyx_f_3csa_3csa_14ConnectionScan_update_departure_stop;
  __pyx_vtable_3csa_3csa_ConnectionScan.update_out_hubs = (PyObject *(*)(struct __pyx_obj_3csa_3csa_ConnectionScan *, int, int, int))__pyx_f_3csa_3csa_14ConnectionScan_update_out_hubs;
  __pyx_vtable_3csa_3csa_ConnectionScan.query = (PyObject *(*)(struct __pyx_obj_3csa_3csa_ConnectionScan *, int, int, int))__pyx_f_3csa_3csa_14ConnectionScan_query;
