...
struct __pyx_t_3csa_14data_structure_Transfer;
static PyObject* __pyx_convert__to_py_struct____pyx_t_3csa_14data_structure_Transfer(struct __pyx_t_3csa_14data_structure_Transfer s);
/* MemviewDtypeToObject.proto */
static CYTHON_INLINE PyObject *__pyx_memview_get_nn_struct____pyx_t_3csa_14data_structure_Transfer(const char *itemp);
static CYTHON_INLINE int __pyx_memview_set_nn_struct____pyx_t_3csa_14data_structure_Transfer(const char *itemp, PyObject *obj);
...
static struct __pyx_t_3csa_14data_structure_Transfer __pyx_convert__from_py_struct____pyx_t_3csa_14data_structure_Transfer(PyObject *); /*proto*/
...
static const char __pyx_k_No_value_specified_for_struct_at[] = "No value specified for struct attribute 'time'";
static const char __pyx_k_Out_of_bounds_on_buffer_access_a[] = "Out of bounds on buffer access (axis %d)";
static const char __pyx_k_Unable_to_convert_item_to_object[] = "Unable to convert item to object";
static const char __pyx_k_got_differing_extents_in_dimensi[] = "got differing extents in dimension %d (got %d and %d)";
static const char __pyx_k_no_default___reduce___due_to_non[] = "no default __reduce__ due to non-trivial __cinit__";
static const char __pyx_k_unable_to_allocate_shape_and_str[] = "unable to allocate shape and strides.";
static const char __pyx_k_No_value_specified_for_struct_at_2[] = "No value specified for struct attribute 'dest_id'";
 ...
 */
  if (unlikely(!__pyx_v_3csa_9timetable_transfers.memview)) { __Pyx_RaiseUnboundLocalError("transfers"); __PYX_ERR(0, 6, __pyx_L1_error) }
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_3csa_9timetable_transfers, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn_struct____pyx_t_3csa_14data_structure_Transfer, (int (*)(char *, PyObject *)) __pyx_memview_set_nn_struct____pyx_t_3csa_14data_structure_Transfer, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     print(transfers[0].time)
 */
  if (unlikely(!__pyx_v_3csa_9timetable_transfers.memview)) { __Pyx_RaiseUnboundLocalError("transfers"); __PYX_ERR(0, 7, __pyx_L1_error) }
  __pyx_t_3 = 0;
  __pyx_t_4 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_3csa_9timetable_transfers.shape[0];
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_4 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_v_3csa_9timetable_transfers.shape[0])) __pyx_t_4 = 0;
  if (unlikely(__pyx_t_4 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_4);
    __PYX_ERR(0, 7, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_convert__to_py_struct____pyx_t_3csa_14data_structure_Transfer((*((struct __pyx_t_3csa_14data_structure_Transfer *) ( /* dim=0 */ (__pyx_v_3csa_9timetable_transfers.data + __pyx_t_3 * __pyx_v_3csa_9timetable_transfers.strides[0]) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     print(transfers[0].time)             # <<<<<<<<<<<<<<
 */
  if (unlikely(!__pyx_v_3csa_9timetable_transfers.memview)) { __Pyx_RaiseUnboundLocalError("transfers"); __PYX_ERR(0, 8, __pyx_L1_error) }
  __pyx_t_5 = 0;
  __pyx_t_4 = -1;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_v_3csa_9timetable_transfers.shape[0];
    if (unlikely(__pyx_t_5 < 0)) __pyx_t_4 = 0;
  } else if (unlikely(__pyx_t_5 >= __pyx_v_3csa_9timetable_transfers.shape[0])) __pyx_t_4 = 0;
  if (unlikely(__pyx_t_4 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_4);
    __PYX_ERR(0, 8, __pyx_L1_error)
  }
  __pyx_t_1 = __Pyx_PyInt_From_int((*((struct __pyx_t_3csa_14data_structure_Transfer *) ( /* dim=0 */ (__pyx_v_3csa_9timetable_transfers.data + __pyx_t_5 * __pyx_v_3csa_9timetable_transfers.strides[0]) ))).time); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 * @cname("__pyx_convert__from_py_struct____pyx_t_3csa_14data_structure_Transfer")
 * cdef struct_type __pyx_convert__from_py_struct____pyx_t_3csa_14data_structure_Transfer(obj) except *:             # <<<<<<<<<<<<<<
 *     cdef struct_type result
 *     if not PyMapping_Check(obj):
 */

static struct __pyx_t_3csa_14data_structure_Transfer __pyx_convert__from_py_struct____pyx_t_3csa_14data_structure_Transfer(PyObject *__pyx_v_obj) {
  struct __pyx_t_3csa_14data_structure_Transfer __pyx_v_result;
  PyObject *__pyx_v_value = NULL;
  struct __pyx_t_3csa_14data_structure_Transfer __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  __Pyx_RefNannySetupContext("__pyx_convert__from_py_struct____pyx_t_3csa_14data_structure_Transfer", 0);
 ...
 */
      __pyx_t_2 = __Pyx_PyObject_Dict_GetItem(__pyx_v_obj, __pyx_n_s_time); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 17, __pyx_L4_error)
      __Pyx_GOTREF(__pyx_t_2);
 ...
 */
    ...
    if (__pyx_t_6) {
      __Pyx_AddTraceback("FromPyStructUtility.__pyx_convert__from_py_struct____pyx_t_3csa_14data_structure_Transfer", __pyx_clineno, __pyx_lineno, __pyx_filename);
 ...
 *         value = obj['dest_id']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'dest_id'")
 */
      __pyx_t_8 = __Pyx_PyObject_Dict_GetItem(__pyx_v_obj, __pyx_n_s_dest_id); if (unlikely(!__pyx_t_8)) __PYX_ERR(1, 22, __pyx_L12_error)
      __Pyx_GOTREF(__pyx_t_8);
 ...
 */
  ...
  __pyx_v_result.dest_id = __pyx_t_6;
...
static PyMethodDef __pyx_methods[] = {
  {"test", (PyCFunction)__pyx_pw_3csa_3csa_1test, METH_O, 0},
  {0, 0, 0, 0}
};
...
static PyObject* __pyx_convert__to_py_struct____pyx_t_3csa_14data_structure_Transfer(struct __pyx_t_3csa_14data_structure_Transfer s) {
  ...
  member = __Pyx_PyInt_From_int(s.time); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_time, member) < 0)) goto bad;
  Py_DECREF(member);
  member = __Pyx_PyInt_From_int(s.dest_id); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_dest_id, member) < 0)) goto bad;
  Py_DECREF(member);
  return res;
  bad:
  Py_XDECREF(member);
...
static CYTHON_INLINE PyObject *__pyx_memview_get_nn_struct____pyx_t_3csa_14data_structure_Transfer(const char *itemp) {
    return (PyObject *) __pyx_convert__to_py_struct____pyx_t_3csa_14data_structure_Transfer(*(struct __pyx_t_3csa_14data_structure_Transfer *) itemp);
}
static CYTHON_INLINE int __pyx_memview_set_nn_struct____pyx_t_3csa_14data_structure_Transfer(const char *itemp, PyObject *obj) {
    struct __pyx_t_3csa_14data_structure_Transfer value = __pyx_convert__from_py_struct____pyx_t_3csa_14data_structure_Transfer(obj);
    if (PyErr_Occurred())
        return 0;
    *(struct __pyx_t_3csa_14data_structure_Transfer *) itemp = value;
    return 1;
}
