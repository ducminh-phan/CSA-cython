...
static int __Pyx_modinit_variable_export_code(void) {
  ...
  if (__Pyx_ExportVoidPtr(__pyx_n_s_INF, (void *)&__pyx_v_3csa_14data_structure_INF, "__pyx_t_3csa_14data_structure_dtype") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 * cdef dtype INF = 1_000_000_000
 */
  if ((((sizeof(__pyx_t_3csa_14data_structure_dtype)) == 8) != 0)) {
    __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_uint64); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 4, __pyx_L1_error)
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_uint32); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_1 = __pyx_t_2;
    __pyx_t_2 = 0;
  }
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_pdtype, __pyx_t_1) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "csa/data_structure.pyx":6
 * pdtype = np.uint64 if sizeof(dtype) == 8 else np.uint32
 * 
 * cdef dtype INF = 1_000_000_000             # <<<<<<<<<<<<<<
 * 
